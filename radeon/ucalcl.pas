...
uses
  sysutils, ucal, typinfo;

{$Z4} //force all enums to DWord size

const _CALCLdll='aticalcl.dll';
...
(** Kernel source code type *)
  ...
  CALLogFunction=procedure(const msg:PAnsiChar);cdecl; (**< Callback function for dissassembler *)

function calclGetVersion(out major,minor,imp:CALuint):CALresult;stdcall;
function calclCompile(out obj:CALobject;const language:CALlanguage;const source:PAnsiChar;const target:CALtarget):CALresult;stdcall;
function calclLink(out image:CALimage;var obj:CALobject;const objCount:CALuint):CALresult;stdcall;
function calclFreeObject(const obj:CALobject):CALresult;stdcall;
function calclFreeImage(const image:CALimage):CALresult;stdcall;
procedure calclDisassembleImage(const image:CALimage;const logfunc:CALLogFunction);stdcall;
function calclAssembleObject(out obj:CALobject;const typ:CALCLprogramType;const source:PAnsiChar;const target:CALtarget):CALresult;stdcall;
procedure calclDisassembleObject(const obj:CALobject;const logfunc:CALLogFunction);stdcall;
function calclImageGetSize(out size:CALuint;const image:CALimage):CALresult;stdcall;
function calclImageWrite(const buffer:pointer;const size:CALuint;const image:CALimage):CALresult;stdcall;
function calclGetErrorString:PAnsiChar;stdcall;

procedure calclCheck(const res:CALresult;const msg:ansistring);
function calclBuild(const AIL:ansistring;const ATarget:CALTarget):RawByteString;
 ...
 *
 *)
function calclGetVersion(out major,minor,imp:CALuint):CALresult;stdcall;external _CALCLdll  delayed;
 ...
 *)
function calclCompile(out obj:CALobject;const language:CALlanguage;const source:PAnsiChar;const target:CALtarget):CALresult;stdcall;external _CALCLdll  delayed;
 ...
 *)
function calclLink(out image:CALimage;var obj:CALobject;const objCount:CALuint):CALresult;stdcall;external _CALCLdll  delayed;
 ...
 *)
function calclFreeObject(const obj:CALobject):CALresult;stdcall;external _CALCLdll  delayed;
 ...
 * @sa calclLink
 *)
function calclFreeImage(const image:CALimage):CALresult;stdcall;external _CALCLdll  delayed;
 ...
 *)
procedure calclDisassembleImage(const image:CALimage;const logfunc:CALLogFunction);stdcall;external _CALCLdll  delayed;
 ...
 * @sa calclLink calclFreeObject calclFreeImage
 *)
function calclAssembleObject(out obj:CALobject;const typ:CALCLprogramType;const source:PAnsiChar;const target:CALtarget):CALresult;stdcall;external _CALCLdll  delayed;
 ...
 *)
procedure calclDisassembleObject(const obj:CALobject;const logfunc:CALLogFunction);stdcall;external _CALCLdll  delayed;
 ...
 * @sa calclImageWrite
 *)
function calclImageGetSize(out size:CALuint;const image:CALimage):CALresult;stdcall;external _CALCLdll  delayed;
 ...
 *)
function calclImageWrite(const buffer:pointer;const size:CALuint;const image:CALimage):CALresult;stdcall;external _CALCLdll  delayed;
 ...
 *
 *)
function calclGetErrorString:PAnsiChar;stdcall;external _CALCLdll  delayed;

//utility functions

procedure calclCheck(const res:CALresult;const msg:ansistring);
begin
  if res<>CAL_RESULT_OK then
      raise Exception.Create(msg+' '+calclGetErrorString+' '+GetEnumName(TypeInfo(CALResult),ord(res)));
end;
...
begin
  ...
  result:='';
  try
    calclCheck(calclCompile(obj,CAL_LANGUAGE_IL, PAnsiChar(AIL), ATarget),'calclCompile');
