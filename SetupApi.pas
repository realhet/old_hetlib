{
  Setup API defines  (is don't very full list of functions and defines :))

  writed by rpy3uH (aka ahilles)

  e-mail:  gruzino.abhaz@gmail.com

  last modified 1.06.2008

  P.S. I don't like setupapi.pas from Delphi-JEDI.org

  P.P.S. Bonus: In the end of a file there are defines for WM_DEVICECHANGE

  2013 realhet: Added GUID_DEVINTERFACE_USB_DEVICE and SP_DEVICE_INTERFACE_DETAIL_DATA
                Added EnumDevice stuff
}

// http://4coder.org/delphi-source-code/1005/DevList/SetupAPI.pas.html?text
...
function SetupDiEnumDeviceInfo(DeviceInfoSet: HDEVINFO; MemberIndex: DWORD;
 ...
 DeviceInfoData: PSPDevInfoData; Property_: DWORD;
  PropertyRegDataType: PDWORD; PropertyBuffer: PBYTE; PropertyBufferSize: DWORD;
   RequiredSize: PDWORD): BOOL; stdcall; external SetupApiModuleName name 'SetupDiGetDeviceRegistryPropertyA';
...
const
   // Flags for TSPDeviceInterfaceData.Flags field.
   cSPINTActive  = $00000001;
   cSPINTDefault = $00000002;
   cSPINTRemoved = $00000004;

   // Flags controlling what is included in the device information set
   // built by SetupDiGetClassDevs
   cDIGCFDefault         = $00000001;  // only valid with DIGCF_DEVICEINTERFACE
   cDIGCFPresent         = $00000002;
   cDIGCFAllClasses      = $00000004;
   cDIGCFProfile         = $00000008;
   cDIGCFDeviceInterface = $00000010;
   ...
   function SetupDiEnumDeviceInterfaces
     ...
     ): DWORD; stdcall; external SetupApiModuleName name 'SetupDiEnumDeviceInterfaces';
   ...
   function SetupDiGetDeviceInterfaceDetail
     (
          ...
          RequiredSize:                  PDWORD;
          DeviceInfoData:                PSPDevInfoData
     ): DWORD; stdcall; external SetupApiModuleName name 'SetupDiGetDeviceInterfaceDetailA';
   ...
   function SetupDiGetDeviceInstanceId(
     ...
     RequiredSize:PDWORD):BOOL;  stdcall; external SetupApiModuleName name 'SetupDiGetDeviceInstanceIdA';
