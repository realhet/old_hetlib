...
uses Classes, Graphics, SysUtils, uDXTC;
...
procedure DDSLoadFromStream(const bmp:TBitmap;const stream:TStream);
procedure DDSSaveToStream(const bmp:TBitmap;const stream:TStream);
