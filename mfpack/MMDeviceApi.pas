...
uses
	Windows, ActiveX, ComObj, PropSys, DeviceTopology, DXTypes, MMSystem;

const
	//Error types
	{$EXTERNALSYM E_NOTFOUND}
	E_NOTFOUND                          = HRESULT(1168{ERROR_NOT_FOUND});
	{$EXTERNALSYM E_UNSUPPORTED_TYPE}
	E_UNSUPPORTED_TYPE                  = HRESULT(1630{ERROR_UNSUPPORTED_TYPE});
