unit huffman;interface

const ValTab0:array[0..0,0..1]of byte=(
(0,0){ dummy}
);

ValTab1:array[0..7-1,0..1]of byte=(
(2,1),(0,0),(2,1),(0,16),(2,1),(0,1),(0,17)
);
ValTab2:array[0..17-1,0..1]of byte=(
(2,1),(0,0),(4,1),(2,1),(0,16),(0,1),(2,1),(0,17),(4,1),(2,1),
(0,32),(0,33),(2,1),(0,18),(2,1),(0,2),(0,34)
);
ValTab3:array[0..17-1,0..1]of byte=(
(4,1),(2,1),(0,0),(0,1),(2,1),(0,17),(2,1),(0,16),(4,1),(2,1),
(0,32),(0,33),(2,1),(0,18),(2,1),(0,2),(0,34)
);

ValTab4:array[0..0,0..1]of byte=((0,0));{ dummy}

ValTab5:array[0..31-1,0..1]of byte=(
...
ValTab6:array[0..31-1,0..1]of byte=(
...
ValTab7:array[0..71-1,0..1]of byte=(
...
ValTab8:array[0..71-1,0..1]of byte=(
...
ValTab9:array[0..71-1,0..1]of byte=(
...
ValTab10:array[0..127-1,0..1]of byte=(
...
ValTab11:array[0..127-1,0..1]of byte=(
...
ValTab12:array[0..127-1,0..1]of byte=(
...
ValTab13:array[0..511-1,0..1]of byte=(
...
ValTab14:array[0..0,0..1]of byte=(
(0,0){ dummy}
);
ValTab15:array[0..511-1,0..1]of byte=(
...
ValTab16:array[0..511-1,0..1]of byte=(
...
ValTab24:array[0..512-1,0..1]of byte=(
...
ValTab32:array[0..31-1,0..1]of byte=(
...
ValTab33:array[0..31-1,0..1]of byte=(
...
type _2ba=array[0..1023,0..1]of byte;
type huffcodetab=record
  tablename:byte;
  xlen:integer;
  ylen:integer;
  linbits:integer;
...
const ht:array[0..HTN-1]of huffcodetab=(
(tablename:0;xlen:0;ylen:0;linbits:0;linmax:0;ref:-1;val:addr(ValTab0);treelen:0),
(tablename:1;xlen:2;ylen:2;linbits:0;linmax:0;ref:-1;val:addr(ValTab1);treelen:7),
(tablename:2;xlen:3;ylen:3;linbits:0;linmax:0;ref:-1;val:addr(ValTab2);treelen:17),
(tablename:3;xlen:3;ylen:3;linbits:0;linmax:0;ref:-1;val:addr(ValTab3);treelen:17),
(tablename:4;xlen:0;ylen:0;linbits:0;linmax:0;ref:-1;val:addr(ValTab4);treelen:0),
(tablename:5;xlen:4;ylen:4;linbits:0;linmax:0;ref:-1;val:addr(ValTab5);treelen:31),
(tablename:6;xlen:4;ylen:4;linbits:0;linmax:0;ref:-1;val:addr(ValTab6);treelen:31),
(tablename:7;xlen:6;ylen:6;linbits:0;linmax:0;ref:-1;val:addr(ValTab7);treelen:71),
(tablename:8;xlen:6;ylen:6;linbits:0;linmax:0;ref:-1;val:addr(ValTab8);treelen:71),
(tablename:9;xlen:6;ylen:6;linbits:0;linmax:0;ref:-1;val:addr(ValTab9);treelen:71),
(tablename:10;xlen:8;ylen:8;linbits:0;linmax:0;ref:-1;val:addr(ValTab10);treelen:127),
(tablename:11;xlen:8;ylen:8;linbits:0;linmax:0;ref:-1;val:addr(ValTab11);treelen:127),
(tablename:12;xlen:8;ylen:8;linbits:0;linmax:0;ref:-1;val:addr(ValTab12);treelen:127),
(tablename:13;xlen:16;ylen:16;linbits:0;linmax:0;ref:-1;val:addr(ValTab13);treelen:511),
(tablename:14;xlen:0;ylen:0;linbits:0;linmax:0;ref:-1;val:addr(ValTab14);treelen:0),
(tablename:15;xlen:16;ylen:16;linbits:0;linmax:0;ref:-1;val:addr(ValTab15);treelen:511),
(tablename:16;xlen:16;ylen:16;linbits:1;linmax:1;ref:-1;val:addr(ValTab16);treelen:511),
(tablename:17;xlen:16;ylen:16;linbits:2;linmax:3;ref:16;val:addr(ValTab16);treelen:511),
(tablename:18;xlen:16;ylen:16;linbits:3;linmax:7;ref:16;val:addr(ValTab16);treelen:511),
(tablename:19;xlen:16;ylen:16;linbits:4;linmax:15;ref:16;val:addr(ValTab16);treelen:511),
(tablename:20;xlen:16;ylen:16;linbits:6;linmax:63;ref:16;val:addr(ValTab16);treelen:511),
(tablename:21;xlen:16;ylen:16;linbits:8;linmax:255;ref:16;val:addr(ValTab16);treelen:511),
(tablename:22;xlen:16;ylen:16;linbits:10;linmax:1023;ref:16;val:addr(ValTab16);treelen:511),
(tablename:23;xlen:16;ylen:16;linbits:13;linmax:8191;ref:16;val:addr(ValTab16);treelen:511),
(tablename:24;xlen:16;ylen:16;linbits:4;linmax:15;ref:-1;val:addr(ValTab24);treelen:512),
(tablename:25;xlen:16;ylen:16;linbits:5;linmax:31;ref:24;val:addr(ValTab24);treelen:512),
(tablename:26;xlen:16;ylen:16;linbits:6;linmax:63;ref:24;val:addr(ValTab24);treelen:512),
(tablename:27;xlen:16;ylen:16;linbits:7;linmax:127;ref:24;val:addr(ValTab24);treelen:512),
(tablename:28;xlen:16;ylen:16;linbits:8;linmax:255;ref:24;val:addr(ValTab24);treelen:512),
(tablename:29;xlen:16;ylen:16;linbits:9;linmax:511;ref:24;val:addr(ValTab24);treelen:512),
(tablename:30;xlen:16;ylen:16;linbits:11;linmax:2047;ref:24;val:addr(ValTab24);treelen:512),
(tablename:31;xlen:16;ylen:16;linbits:13;linmax:8191;ref:24;val:addr(ValTab24);treelen:512),
(tablename:32;xlen:1;ylen:16;linbits:0;linmax:0;ref:-1;val:addr(ValTab32);treelen:31),
(tablename:33;xlen:1;ylen:16;linbits:0;linmax:0;ref:-1;val:addr(ValTab33);treelen:31)
);
